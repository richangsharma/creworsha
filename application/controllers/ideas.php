...
class Ideas extends CI_Controller{
    ...
    public function index(){
        $data['title'] = 'Ideas|Creworsha-Create what you think.Work on what you like.Share what you have built.';
        $data['ideas'] = $this->ideasmodel->fetchideas();
        $this->load->view('header' , $data);
        $this->load->view('ideas-browser' , $data);
...
public function deleteDir($dirPath) {
   ...
   public function view(){ 
        $data['title'] = 'Home|Creworsha-Create what you think.Work on what you like.Share what you have built.';
        $ideaid = $_GET['id'];
        $data['request_response'] = $this->ideasmodel->reqres($ideaid);
        $data['idea'] = $this->ideasmodel->fetchidea($ideaid);
        $this->load->view('header' , $data);
        $this->load->view('view-idea' , $data);
        $this->load->view('footer' , $data);
   }
   public function connect(){
       ...
       $reciever = $this->request->reciever($idea);
       if($reciever){
       ...
       $pushmsg = array(
           'sentfrom'  => $sender,
           'sentto' => $recieverid,
           'sendername' => $this->session->userdata('fullname'),
           'message' => $message,
           'id' => $idea,
           'ideaname' => $ideaname,
           'scope' => 'ideas'
       );
       $response = $this->ideasmodel->connect($pushmsg);
